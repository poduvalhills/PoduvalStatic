                ...
                <div className="row" id="videos">
                    <div className="col-md-4 text-center">
                            <video width="400" controls style="display:none">                              
                              <source src={require('../media/checkdam.mp4')} type="video/mp4" style="display:none" />
                    ...
                    <div className="col-md-4 text-center">
                        <video width="400" controls style="display:none">                              
                          <source src={require('../media/hills.mp4')} type="video/mp4" style="display:none" />
                    ...
                    <div className="col-md-4 text-center">
                        <video width="400" controls style="display:none">                              
                          <source src={require('../media/views.mp4')} type="video/mp4" style="display:none" />
